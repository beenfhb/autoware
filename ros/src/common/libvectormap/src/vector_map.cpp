...
void VectorMap::load_points(const vector_map::PointArray &msg) {
  ...
  std::cout << "load points complete. element num: " << points.size()
            << std::endl;
...
void VectorMap::load_vectors(const vector_map::VectorArray &msg) {
  ...
  std::cout << "load vectors complete. element num: " << vectors.size()
            << std::endl;
...
void VectorMap::load_signals(const vector_map::SignalArray &msg) {
  ...
  std::cout << "load signals complete. element num: " << signals.size()
            << std::endl;
