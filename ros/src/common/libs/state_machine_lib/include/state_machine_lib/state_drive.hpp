...
class DriveBehaviorLaneChangeLeftState
    : public State<DriveBehaviorLaneChangeLeftState> {
private:
...
class DriveBehaviorLaneChangeRightState
    : public State<DriveBehaviorLaneChangeRightState> {
private:
...
class DriveBehaviorObstacleAvoidanceState
    : public State<DriveBehaviorObstacleAvoidanceState> {
private:
...
class DriveBehaviorTrafficLightRedState
    : public State<DriveBehaviorTrafficLightRedState> {
private:
...
class DriveBehaviorTrafficLightGreenState
    : public State<DriveBehaviorTrafficLightGreenState> {
private:
...
class DriveBehaviorStoplinePlanState
    : public State<DriveBehaviorStoplinePlanState> {
private:
...
class DriveBehaviorAcceptLanechangeState
    : public State<DriveBehaviorAcceptLanechangeState> {
private:
