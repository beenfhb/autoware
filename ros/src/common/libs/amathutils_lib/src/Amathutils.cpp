...
bool isIntersectLine(double p1x, double p1y, double p2x, double p2y, double p3x,
...
int isPointLeftFromLine(double p1x, double p1y, double line_p1x,
                        double line_p1y, double line_p2x, double line_p2y) {
  double n = p1x * (line_p1y - line_p2y) + line_p1x * (line_p2y - p1y) +
