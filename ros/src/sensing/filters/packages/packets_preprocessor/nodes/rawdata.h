...
namespace velodyne_rawdata
{
  ...
  public:
    ...
    void unpack_invalid(const velodyne_msgs::VelodynePacket &pkt, DataContainerBase& data);
  ...
  private:
    ...
    void unpack_vlp16_invalid(const velodyne_msgs::VelodynePacket &pkt, DataContainerBase& data);
