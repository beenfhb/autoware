...
#define MIP_GPS_ECEF_POS_PACKET_VALID                                          \
  (MIP_GPS_ECEF_POS_POSITION_VALID | MIP_GPS_ECEF_POS_ACCURACY_ESTIMATE_VALID)
...
#define MIP_GPS_NED_VEL_PACKET_VALID                                           \
  (MIP_GPS_NED_VEL_VELOCITY_VALID | MIP_GPS_NED_VEL_SPEED_3D_VALID |           \
   ...
   MIP_GPS_NED_VEL_SPEED_ACCURACY_VALID |                                      \
   MIP_GPS_NED_VEL_HEADING_ACCURACY_VALID)
...
#define MIP_GPS_ECEF_VEL_PACKET_VALID                                          \
  (MIP_GPS_ECEF_VEL_VELOCITY_VALID | MIP_GPS_ECEF_VEL_ACCURACY_ESTIMATE_VALID)
...
#define MIP_GPS_UTC_TIME_PACKET_VALID                                          \
  (MIP_GPS_UTC_TIME_GPS_TIME_DATE_VALID |                                      \
   MIP_GPS_UTC_TIME_LEAP_SECONDS_KNOWN_VALID)
...
#define MIP_GPS_TIME_PACKET_VALID                                              \
  (MIP_GPS_TIME_TOW_VALID | MIP_GPS_TIME_WEEK_NUMBER_VALID)
...
void mip_gps_dgps_channel_status_byteswap(
    mip_gps_dgps_channel_status *dgps_channel_status);
