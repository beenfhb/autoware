...
#define MIP_AHRS_DATA_DELTA_VELOCITY                                           \
  0x08 // 12: 3 single (vector) (meters/second)
#define MIP_AHRS_DATA_ORIENTATION_MATRIX                                       \
  0x09                                // 36: 9 single (Matrix) (no units)
#define MIP_AHRS_DATA_QUATERNION 0x0A // 16: 4 single (Quaternion) (no units)
#define MIP_AHRS_DATA_ORIENTATION_UPDATE_MATRIX                                \
  0x0B // 36: 9 single (Matrix) (no units)
#define MIP_AHRS_DATA_EULER_ANGLES 0x0C
#define MIP_AHRS_DATA_TEMPERATURE_RAW 0x0D // 8:  4 u16  		(no
                                           // units)
#define MIP_AHRS_DATA_TIME_STAMP_INTERNAL                                      \
  0x0E // 4:  1 u32 (Integer) (device specific)
#define MIP_AHRS_DATA_TIME_STAMP_PPS                                           \
  0x0F                              // 9:  u8 flags u32 seconds u32 nanoseconds
#define MIP_AHRS_DATA_STAB_MAG 0x10 // 12: 3 single (vector) (Gauss)
#define MIP_AHRS_DATA_STAB_ACCEL 0x11 // 12: 3 single (vector) (g)
#define MIP_AHRS_DATA_TIME_STAMP_GPS                                           \
  0x12 // 14: double GPS TOW u16 GPS week number u16 flags
...
typedef struct _mip_ahrs_raw_temp {
  u16 raw_temp[4]; // 0 = Mag, 1 = Gyro_3/Accel_3, 2 = Gyro_2/Accel_1/Accel_2, 3
                   // = Gyro_1
} mip_ahrs_raw_temp;
