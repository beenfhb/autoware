...
//
//! @fn
//! u16 mip_system_com_mode(mip_interface *device_interface, u8
//! function_selector, u8 *com_mode)
//
//! @section DESCRIPTION
...
//! perform.
//! @param [in,out] u8 *com_mode                - The communications mode. (used
...
u16 mip_system_com_mode(mip_interface *device_interface, u8 function_selector,
  ...
  return_code = mip_interface_send_command_with_response(
      device_interface, MIP_SYSTEM_COMMAND_SET, MIP_SYSTEM_CMD_COM_MODE,
