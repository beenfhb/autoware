...
#define MIP_MAX_PACKET_SIZE                                                    \
  (MIP_HEADER_SIZE + MIP_MAX_PAYLOAD_SIZE + MIP_CHECKSUM_SIZE)

////////////////////////////////////////////////////////////////////////////////
// GLOBAL MIP DESCRIPTORS  (global desc are 0xF0 - 0xFF) - same usage in all
// descriptor sets
////////////////////////////////////////////////////////////////////////////////

#define MIP_REPLY_DESC_GLOBAL_ACK_NACK 0xF1 // Ack/nack desc is same in all sets
#define MIP_DESC_GLOBAL_PRODUCTION_TEST                                        \
  0xFE // Production Test desc is same in all sets
