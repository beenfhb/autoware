...
//! @section DETAILS
//!
//! @param [in] mip_gps_clock_info *clock_info - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
//
//! @fn
//! void mip_gps_dgps_channel_status_byteswap(mip_gps_dgps_channel_status
//! *dgps_channel_status)
//
//! @section DESCRIPTION
...
//! @section DETAILS
//!
//! @param [in] mip_gps_dgps_channel_status *dgps_channel_status - The structure
//! to be byteswapped.
//
//! @section NOTES
//!
...
void mip_gps_dgps_channel_status_byteswap(
  ...
  byteswap_inplace(&dgps_channel_status->pseudorange_rate_correction,
                   sizeof(float));
