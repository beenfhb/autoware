...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_scaled_accel *scaled_accel - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_scaled_gyro *scaled_gyro - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_scaled_mag *scaled_mag - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_delta_theta *delta_theta - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
//
//! @fn
//! void mip_ahrs_delta_velocity_byteswap(mip_ahrs_delta_velocity
//! *delta_velocity)
//
//! @section DESCRIPTION
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_delta_velocity *delta_velocity - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
//
//! @fn
//! void mip_ahrs_orientation_matrix_byteswap(mip_ahrs_orientation_matrix
//! *orientation_matrix)
//
//! @section DESCRIPTION
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_orientation_matrix *orientation_matrix - The structure
//! to be byteswapped.
//
//! @section NOTES
//!
...
void mip_ahrs_orientation_matrix_byteswap(
    mip_ahrs_orientation_matrix *orientation_matrix) {
  u8 i, j;
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_quaternion *quaternion - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_euler_angles *euler_angles - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
//! @fn
//! void
//! mip_ahrs_orientation_update_matrix_byteswap(mip_ahrs_orientation_update_matrix
//! *orientation_update_matrix)
//
//! @section DESCRIPTION
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_orientation_update_matrix *orientation_update_matrix -
...
void mip_ahrs_orientation_update_matrix_byteswap(
    mip_ahrs_orientation_update_matrix *orientation_update_matrix) {
  u8 i, j;
...
//
//! @fn
//! void mip_ahrs_internal_timestamp_byteswap(mip_ahrs_internal_timestamp
//! *internal_timestamp)
//
//! @section DESCRIPTION
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_internal_timestamp *internal_timestamp - The structure
//! to be byteswapped.
//
//! @section NOTES
//!
...
void mip_ahrs_internal_timestamp_byteswap(
    mip_ahrs_internal_timestamp *internal_timestamp) {
...
//
//! @fn
//! void mip_ahrs_1pps_timestamp_byteswap(mip_ahrs_1pps_timestamp
//! *pps_timestamp)
//
//! @section DESCRIPTION
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_1pps_timestamp *pps_timestamp - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_gps_timestamp *gps_timestamp - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_north_vector *north_vector - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
//
//! @fn
//! void mip_ahrs_signal_settings_byteswap(mip_ahrs_signal_settings
//! *signal_settings)
//
//! @section DESCRIPTION
...
//! @section DETAILS
//!
//! @param [in] mip_ahrs_signal_settings *signal_settings - The structure to be
//! byteswapped.
//
//! @section NOTES
//!
...
void mip_ahrs_signal_settings_byteswap(
    mip_ahrs_signal_settings *signal_settings) {
