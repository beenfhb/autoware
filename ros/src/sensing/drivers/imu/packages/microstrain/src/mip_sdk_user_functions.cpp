...
//! @param [in] int port_num       - port number (as recognized by the operating
//! system.)
...
//! @section NOTES
//!
//! The user should copy the \c mip_sdk_user_functions.c file to their project
...
//
//! @fn
//! u16 mip_sdk_port_write(void *port_handle, u8 *buffer, u32 num_bytes, u32
//! *bytes_written, u32 timeout_ms)
//
//! @section DESCRIPTION
...
//
//! @fn
//! u16 mip_sdk_port_read(void *port_handle, u8 *buffer, u32 num_bytes, u32
//! *bytes_read, u32 timeout_ms)
//
//! @section DESCRIPTION
//! Target-Specific Port Write Function.
//
...
//! @param [in]  u8 *buffer         - buffer containing num_bytes of data
//! @param [in]  u32 num_bytes      - the number of bytes to write to the port
//! @param [out] u32 *bytes_read    - the number of bytes actually read from the
//! device
...
//! @section NOTES
//!
//!   1) This value should no roll-over in short periods of time (e.g.
//!   minutes)\n 2) Most systems have a millisecond counter that rolls-over
//!   every 32 bits\n
...
//!   4) The user should copy the \c mip_sdk_user_functions.c file to their
