...
public:
  ...
  // Returns the elapsed time in seconds since the timer was started or
  // restarted.
  TimeDuration elapsed() const;
  //	double elapsed () const;

  /// Returns the elapsed time in milliseconds since the timer was started or
  /// restarted.
  UINT32 elapsedMilliseconds() const;

  /// Returns the elapsed time in microseconds since the timer was started or
  /// restarted.
  UINT32 elapsedMicroseconds() const;

  UINT32 elapsedMillisecondsSinceLastCall(); ///< Elapsed ms since the last call
                                             ///< of this function.
  UINT32 elapsedMicrosecondsSinceLastCall(); ///< Elapsed us since the last call
                                             ///< of this function.
