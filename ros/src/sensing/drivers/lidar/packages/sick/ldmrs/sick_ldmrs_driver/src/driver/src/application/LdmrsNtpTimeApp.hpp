...
private:
  ...
  //	bool changeFlexResConfiguration(const ScannerInfo::ResolutionMap&
  //configuredRM); 	bool
  //changeAngularResolutionType(devices::AngularResolutionType type); 	bool
  //readDetailedErrorCode(UINT32* code = NULL);
