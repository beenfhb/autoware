...
std::string Point2D::toString(UINT16 digits) const {
  std::string text = "(" + ::toString(getX(), (int)digits) + ", " +
                     ::toString(getY(), (int)digits) + ")";
  return text;
}
