...
// 	 *
// 	 * \param endThisThread A bool flag that may be set by the callback
// function
// 	 *  to "false" in case the thread function decides this thread
// 	 *  needs to end.
// 	 *
...
// 	typedef void (*ThreadFunction) (bool& endThisThread, UINT16&
// sleepTimeMs);
//
// 	/**
...
//
// 	/// Set the sleep time between subsequent ThreadFunctionSimple calls in
// [milliseconds] 	void setSleepTimeMilliseconds(unsigned v);
//
// 	/// Returns the sleep time between subsequent ThreadFunctionSimple
// 	/// calls in [milliseconds]. (Default value is zero.)
// 	unsigned getSleepTimeMilliseconds() const { return
// m_sleepTimeMilliseconds; }
//
// private:
// 	static void* thread(void* ptr);			// The thread function
// 	void thread2();							// The member thread
// function
//
