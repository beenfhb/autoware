...
BasicApplication::BasicApplication()
    : m_beVerbose(false), m_applicationType(Sourcetype_Unknown), m_sourceId(0) {
...
BasicApplication::~BasicApplication() {
  ...
  infoMessage("BasicApplication(): Destructor is done - object is dead.",
              m_beVerbose);
}
...
//
std::string BasicApplication::getApplicationName() { return m_applicationName; }
...
//
UINT16 BasicApplication::getApplicationType() { return m_applicationType; }
 ...
 */
UINT16 BasicApplication::getSourceId() { return m_sourceId; }

/**
 * Die System-Eindeutige ID der Applikation, als Zahl.
 */
void BasicApplication::setSourceId(UINT16 sourceId) { m_sourceId = sourceId; }
