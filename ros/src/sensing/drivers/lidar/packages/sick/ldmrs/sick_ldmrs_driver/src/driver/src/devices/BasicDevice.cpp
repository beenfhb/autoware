...
// ****************************************************************************
BasicDevice::BasicDevice() : m_beVerbose(false) {
...
BasicDevice::~BasicDevice() {
  ...
  infoMessage("BasicDevice(): Destructor is done - object is dead.",
              m_beVerbose);
}
 ...
 */
UINT16 BasicDevice::getDevicetype() { return m_devicetype; }
 ...
 */
UINT16 BasicDevice::getSourceId() { return m_sourceId; }

/**
 * Die eindeutige ID des Devices, als Zahl.
 */
void BasicDevice::setSourceId(UINT16 sourceId) { m_sourceId = sourceId; }

//
// Setzt den sprechenden Namen des Geraets.
//
void BasicDevice::setDeviceName(std::string name) { m_deviceName = name; }

//
// Liefert den sprechenden Namen des Geraets.
//
std::string BasicDevice::getDeviceName() { return m_deviceName; }
