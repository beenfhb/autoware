...
template <typename T1, typename T2, typename T3> class SingleSynchronizer {
public:
  SingleSynchronizer(const std::string sub1_topic, const std::string sub2_topic,
                     const std::string pub1_topic, const std::string pub2_topic,
                     const std::string req_topic, const std::string ns);
  void run();
