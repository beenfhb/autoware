...
Synchronizer<T1, T2, T3>::Synchronizer(const std::string sub1_topic,
...
void Synchronizer<T1, T2, T3>::thread() {
  ...
  ros::Subscriber req_sub =
      nh_rcv.subscribe(req_topic_, 1, &Synchronizer::req_callback, this);
  while (nh_rcv.ok()) {
#else
  while (ros::ok()) {
#endif
...
template <typename T1, typename T2, typename T3>
void Synchronizer<T1, T2, T3>::type1_callback(
...
template <typename T1, typename T2, typename T3>
void Synchronizer<T1, T2, T3>::type2_callback(
...
template <typename T1, typename T2, typename T3>
void Synchronizer<T1, T2, T3>::req_callback(
