...
public:
    ...
    ~LaneNetwork();
    void updateLane(autoware_map_msgs::LaneArray lane);
    void updateLaneRelation(autoware_map_msgs::LaneRelationArray relations);
    void updateLaneChangeRelation(autoware_map_msgs::LaneChangeRelationArray relations);
