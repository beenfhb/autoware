...
public:
  ...
  BehaviorStateMachine(PlanningParams *pParams,
                       PreCalculatedConditions *pPreCalcVal,
...
public:
  ForwardState(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
               BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  ForwardStateII(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
                 BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
    m_Behavior = FORWARD_STATE;
  }
...
public:
  MissionAccomplishedState(PlanningParams *pParams,
                           PreCalculatedConditions *pPreCalcVal,
                           BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  MissionAccomplishedStateII(PlanningParams *pParams,
                             PreCalculatedConditions *pPreCalcVal,
                             BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
    m_Behavior = FINISH_STATE;
...
public:
  FollowState(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
              BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  FollowStateII(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
                BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
    m_Behavior = FOLLOW_STATE;
  }
...
public:
  SwerveState(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
              BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  SwerveStateII(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
                BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
    m_Behavior = OBSTACLE_AVOIDANCE_STATE;
  }
...
public:
  StopState(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
            BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  TrafficLightStopState(PlanningParams *pParams,
                        PreCalculatedConditions *pPreCalcVal,
                        BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  TrafficLightWaitState(PlanningParams *pParams,
                        PreCalculatedConditions *pPreCalcVal,
                        BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  StopSignStopState(PlanningParams *pParams,
                    PreCalculatedConditions *pPreCalcVal,
                    BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  StopSignStopStateII(PlanningParams *pParams,
                      PreCalculatedConditions *pPreCalcVal,
                      BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
    m_Behavior = STOP_SIGN_STOP_STATE;
...
public:
  StopSignWaitState(PlanningParams *pParams,
                    PreCalculatedConditions *pPreCalcVal,
                    BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  StopSignWaitStateII(PlanningParams *pParams,
                      PreCalculatedConditions *pPreCalcVal,
                      BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
    m_Behavior = STOP_SIGN_WAIT_STATE;
...
public:
  WaitState(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
            BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  InitState(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
            BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  InitStateII(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
              BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
    m_Behavior = INITIAL_STATE;
  }
...
public:
  GoalState(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
            BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
...
public:
  GoalStateII(PlanningParams *pParams, PreCalculatedConditions *pPreCalcVal,
              BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
    m_Behavior = GOAL_STATE;
  }
...
public:
  TrafficLightStopStateII(PlanningParams *pParams,
                          PreCalculatedConditions *pPreCalcVal,
                          BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
    m_Behavior = TRAFFIC_LIGHT_STOP_STATE;
...
public:
  TrafficLightWaitStateII(PlanningParams *pParams,
                          PreCalculatedConditions *pPreCalcVal,
                          BehaviorStateMachine *pNextState)
      : BehaviorStateMachine(pParams, pPreCalcVal, pNextState) {
    m_Behavior = TRAFFIC_LIGHT_WAIT_STATE;
