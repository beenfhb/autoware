...
int HevComm::StartComm() { return 1; }
...
bool HevComm::GetDriveMotorStatus() { return true; }

bool HevComm::GetSteerMotorStatus() { return true; }
...
double HevComm::GetCurrentBrakeValue() { return 0; }
