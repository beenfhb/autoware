#ifndef POINTCLOUD_PROJECTOR_H_INCLUDED
#define POINTCLOUD_PROJECTOR_H_INCLUDED
...
{
public:
    PointCloudProjector(double min_area,double max_area);
    ~PointCloudProjector();
...
#endif  //POINTCLOUD_PROJECTOR_H_INCLUDED