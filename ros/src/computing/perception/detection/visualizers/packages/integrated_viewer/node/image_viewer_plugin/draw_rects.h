...
public:
  ...
  void
  DrawImageRect(const autoware_msgs::DetectedObjectArray::ConstPtr &in_objects,
                cv::Mat &image);
  void
  DrawImageBox(const autoware_msgs::DetectedObjectArray::ConstPtr &in_objects,
               cv::Mat &image);
...
private:
  void DrawLabel(const autoware_msgs::DetectedObject &in_object,
                 cv::Mat &image);
