...
void MainWindow::on_pushButton_save_clicked() {
  QString fileName =
      QFileDialog::getSaveFileName(this, tr("Save tuning result"), "",
  ...
  if (!save_filePath.empty()) {
    ...
    QString message = tr("<font color = white> <p>tuning result was saved into "
                         "</p> <p>\"%1\"</p> <p>successfully</p></font>")
                          .arg(fileName);
...
void MainWindow::on_pushButton_loadSetting_clicked() {
  QString fileName =
      QFileDialog::getOpenFileName(this, tr("Open setting file"), "",
                                   tr("yaml file (*.yaml);;All Files(*)"));
...
void MainWindow::on_pushButton_exit_clicked() { exit(EXIT_SUCCESS); }
