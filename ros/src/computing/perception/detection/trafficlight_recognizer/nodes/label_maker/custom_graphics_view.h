...
protected:
  // Custom wheel event slot so that displayed image can be zoomed by mouse
  // operation Ref: https://wiki.qt.io/SmoothZoomInQGraphicsView
...
private:
  ...
  // The utility function to convert point coordinate into valid image
  // coordinate
