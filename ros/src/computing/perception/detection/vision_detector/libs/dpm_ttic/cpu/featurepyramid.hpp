...
extern FLOAT *dpm_ttic_cpu_ini_scales(Model_info *MI, IplImage *IM, int X,
                                      int Y);
// calculate feature pyramid (extended to detect.c)
extern FLOAT **dpm_ttic_cpu_calc_f_pyramid(IplImage *Image, Model_info *MI,
                                           int *FTSIZE, FLOAT *scale);
