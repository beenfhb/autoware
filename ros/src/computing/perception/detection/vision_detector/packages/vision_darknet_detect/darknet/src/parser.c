...
layer parse_rnn(list *options, size_params params) {
  ...
  layer l =
      make_rnn_layer(params.batch, params.inputs, output, params.time_steps,
                     activation, batch_normalize, params.net->adam);
...
layer parse_gru(list *options, size_params params) {
  ...
  layer l =
      make_gru_layer(params.batch, params.inputs, output, params.time_steps,
                     batch_normalize, params.net->adam);
...
layer parse_lstm(list *options, size_params params) {
  ...
  layer l =
      make_lstm_layer(params.batch, params.inputs, output, params.time_steps,
                      batch_normalize, params.net->adam);
...
layer parse_region(list *options, size_params params) {
  ...
  layer l =
      make_region_layer(params.batch, params.w, params.h, num, classes, coords);
  assert(l.outputs == params.inputs);
...
detection_layer parse_detection(list *options, size_params params) {
  ...
  detection_layer layer = make_detection_layer(params.batch, params.inputs, num,
                                               side, classes, coords, rescore);
...
crop_layer parse_crop(list *options, size_params params) {
  ...
  crop_layer l = make_crop_layer(batch, h, w, c, crop_height, crop_width, flip,
...
layer parse_reorg(list *options, size_params params) {
  ...
  layer layer =
      make_reorg_layer(batch, w, h, c, stride, reverse, flatten, extra);
  return layer;
}
...
maxpool_layer parse_maxpool(list *options, size_params params) {
  ...
  maxpool_layer layer =
      make_maxpool_layer(batch, h, w, c, size, stride, padding);
  return layer;
}
...
dropout_layer parse_dropout(list *options, size_params params) {
  ...
  dropout_layer layer =
      make_dropout_layer(params.batch, params.inputs, probability);
