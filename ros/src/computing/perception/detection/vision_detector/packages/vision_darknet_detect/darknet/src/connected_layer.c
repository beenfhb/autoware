...
void update_connected_layer(layer l, update_args a) {
  ...
  axpy_cpu(l.inputs * l.outputs, -decay * batch, l.weights, 1, l.weight_updates,
           1);
...
void update_connected_layer_gpu(layer l, update_args a) {
  ...
  int batch = a.batch;
  if (a.adam) {
    adam_update_gpu(l.weights_gpu, l.weight_updates_gpu, l.m_gpu, l.v_gpu, a.B1,
                    a.B2, a.eps, decay, learning_rate, l.inputs * l.outputs,
                    batch, a.t);
    ...
    axpy_gpu(l.inputs * l.outputs, learning_rate / batch, l.weight_updates_gpu,
             1, l.weights_gpu, 1);
