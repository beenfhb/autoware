...
void forward_shortcut_layer_gpu(const layer l, network net) {
  ...
  shortcut_gpu(l.batch, l.w, l.h, l.c, net.layers[l.index].output_gpu, l.out_w,
               l.out_h, l.out_c, l.alpha, l.beta, l.output_gpu);
...
void backward_shortcut_layer_gpu(const layer l, network net) {
  ...
  shortcut_gpu(l.batch, l.out_w, l.out_h, l.out_c, l.delta_gpu, l.w, l.h, l.c,
               1, l.beta, net.layers[l.index].delta_gpu);
}
#endif
