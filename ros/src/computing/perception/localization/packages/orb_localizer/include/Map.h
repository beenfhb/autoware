...
public:
  ...
  void loadFromDisk(const std::string &filename,
                    KeyFrameDatabase *kfMemDb = NULL);

  struct MapFileHeader {
    char signature[7];
    long unsigned int numOfKeyFrame, numOfMapPoint, numOfReferencePoint;
  };
  ...
  KeyFrame *getNearestKeyFrame(const Eigen::Vector3f &position,
