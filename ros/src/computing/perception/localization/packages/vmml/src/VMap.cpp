...
void VMap::estimateStructure (const kfid &kfid1, const kfid &kfid2)
{
	...
	TTransform T12;
	Matcher::matchAny(kf1, kf2, featurePairs_1_2, descriptorMatcher, T12);

	vector<mpid> newMapPointList;

	KeyFrame::triangulate(kf1, kf2, featurePairs_1_2, newMapPointList, framePoints[kfid1], framePoints[kfid2], *this);
