...
public:
  ...
  void align(typename pcl::PointCloud<PointSourceType> &output,
  ...
  void
  updateInputTarget(typename pcl::PointCloud<PointTargetType>::Ptr new_cloud);
...
protected:
  ...
  Eigen::Matrix<float, 4, 4> final_transformation_, transformation_,
