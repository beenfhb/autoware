...
template <typename PointSourceType, typename PointTargetType>
void Registration<PointSourceType, PointTargetType>::setTransformationEpsilon(
    double trans_eps) {
...
template <typename PointSourceType, typename PointTargetType>
double
Registration<PointSourceType, PointTargetType>::getTransformationEpsilon()
    const {
  return transformation_epsilon_;
}

template <typename PointSourceType, typename PointTargetType>
void Registration<PointSourceType, PointTargetType>::setMaximumIterations(
    int max_itr) {
  max_iterations_ = max_itr;
}

template <typename PointSourceType, typename PointTargetType>
int Registration<PointSourceType, PointTargetType>::getMaximumIterations()
    const {
...
Registration<PointSourceType, PointTargetType>::getFinalTransformation() const {
  return final_transformation_;
}

template <typename PointSourceType, typename PointTargetType>
int Registration<PointSourceType, PointTargetType>::getFinalNumIteration()
    const {
...
template <typename PointSourceType, typename PointTargetType>
void Registration<PointSourceType, PointTargetType>::setInputSource(
    typename pcl::PointCloud<PointSourceType>::Ptr input) {
  source_cloud_ = input;
}

// Set input MAP data
template <typename PointSourceType, typename PointTargetType>
void Registration<PointSourceType, PointTargetType>::setInputTarget(
    typename pcl::PointCloud<PointTargetType>::Ptr input) {
  target_cloud_ = input;
}

template <typename PointSourceType, typename PointTargetType>
void Registration<PointSourceType, PointTargetType>::align(
...
template <typename PointSourceType, typename PointTargetType>
void Registration<PointSourceType, PointTargetType>::align(
    typename pcl::PointCloud<PointSourceType> &output,
    const Eigen::Matrix<float, 4, 4> &guess) {
  align(guess);
}

template <typename PointSourceType, typename PointTargetType>
void Registration<PointSourceType, PointTargetType>::computeTransformation(
    const Eigen::Matrix<float, 4, 4> &guess) {
